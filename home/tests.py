...
class TestModal(TestCase):
    def setUp(self):
        ...
        self.user1 = User.objects.create(username='thestartupgazette', email='contact@thestartupgazette.com')
    ...
    def test_user(self):
        self.assertEquals(self.user1.username, 'thestartupgazette')
    ...
    def test_post(self):
        ...
        post1 = Post.objects.create(
            ...
            writer=self.user1,
            meta_description='this is thestartupgazette article meta description',
            meta_keyword='articles,book,lerning,thestartupgazette',
        )
        ...
        for obj in all:
            ...
            self.assertEquals(obj.meta_description, 'this is thestartupgazette article meta description')
            self.assertEquals(obj.meta_keyword, 'articles,book,lerning,thestartupgazette')
